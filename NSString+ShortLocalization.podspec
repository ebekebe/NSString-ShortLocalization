#
#  Be sure to run `pod spec lint NSString+ShortLocalization.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/NSString+ShortLocalization"
  ...
  s.source       = { :git => "http://EXAMPLE/NSString+ShortLocalization.git", :tag => "0.0.1" }
